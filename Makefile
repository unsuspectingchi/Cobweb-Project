...
CPPFLAGS := -I $(SDL_DIR)/sdl2/2.0.14_1/include/SDL2 -I $(SDL_DIR)/sdl2_ttf/2.0.15/include/SDL2 -I $(SDL_DIR)/sdl2_image/2.0.5/include/SDL2 -I $(SDL_DIR)/sdl2_mixer/2.0.4/include/SDL2 -Iinc -MMD -MP
CXXFLAGS := -Wall -Wextra -std=c++17 -ggdb $(TARGET)
LDFLAGS  := -Llib -L $(SDL_DIR)/sdl2/2.0.14_1/lib -L $(SDL_DIR)/sdl2_ttf/2.0.15/lib -L $(SDL_DIR)/sdl2_image/2.0.5/lib -L $(SDL_DIR)/sdl2_mixer/2.0.4/lib
LDLIBS   := -l SDL2-2.0.0 -l SDL2_ttf -l SDL2_image-2.0.0 -l SDL2_mixer-2.0.0
